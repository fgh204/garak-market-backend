    ...
    protected void configure(HttpSecurity http) throws Exception {
    	http.httpBasic().disable()
    		...
    		.and()
                ...
                .antMatchers("/product/uploadImageInfo").permitAll()
                .antMatchers("/kakao/authorization/callback").permitAll()
                .antMatchers("/apple/authorization/callback").permitAll()
                .antMatchers("/market/domaado/signin").permitAll()
                .antMatchers("/market/autoSignin").permitAll()
                .antMatchers("/market/addLog").permitAll()
                ...
                //.antMatchers("/market/domaado/emailDuplicated").permitAll()
                //.antMatchers("/market/domaado/signup").permitAll()
                //.antMatchers("/market/domaado/signingOut").permitAll()
